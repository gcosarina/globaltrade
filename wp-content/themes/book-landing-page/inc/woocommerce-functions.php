...
add_filter( 'woocommerce_show_page_title' ,     'book_landing_page_woo_hide_page_title' );
...
/**
 * book_landing_page_woo_hide_page_title
 *
 ...
 * @return      void
*/
function book_landing_page_woo_hide_page_title() {
