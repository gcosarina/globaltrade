...
<footer class="footer">
	...
	<div class="container-fluid bs-copyright">
		<div class="container">
			...
			<div class="col-md-12 col-sm-12 footer-title">
			<p><?php esc_html_e('Copyright ','store-corner'); ?><a href="<?php echo esc_url('http://localhost:8888/globaltrade/wp-admin/'); ?>" target="_blank"><?php esc_html_e('© 2015 GlobalTrade.com','store-corner'); ?></a></p>
			</div>
			</div>
		</div>
	</div>
