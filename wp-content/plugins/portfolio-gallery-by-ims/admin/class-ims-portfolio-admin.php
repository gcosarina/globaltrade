   ...
   */
	...
	public function admin_init(){
      ...
      if( get_option('ims_portfolio_dummy_data') != 1 )
      {
		...
		update_post_meta( $the_post_id, 'ims_thumb_img', 'http://acewebx.com/wp-content/uploads/2017/12/ims.jpg' );
		update_post_meta( $the_post_id, 'ims_large_img', 'http://acewebx.com/wp-content/uploads/2017/12/IMS.jpg' );
		...
		update_post_meta( $the_post_id, 'ims_thumb_img', 'http://acewebx.com/wp-content/uploads/2017/12/justdiscover.jpg' );
		update_post_meta( $the_post_id, 'ims_large_img', 'http://acewebx.com/wp-content/uploads/2017/12/JustDiscover.jpg' );
		...
		update_post_meta( $the_post_id, 'ims_thumb_img', 'http://acewebx.com/wp-content/uploads/2017/12/offerground.jpg' );
		update_post_meta( $the_post_id, 'ims_large_img', 'http://acewebx.com/wp-content/uploads/2017/12/OfferGround.jpg' );
